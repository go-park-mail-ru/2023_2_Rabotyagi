...
func easyjsonB0091c22DecodeGithubComGoParkMailRu20232RabotyagiPkgModels3(in *jlexer.Lexer, out *preProductJSON) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "images":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v7 Image
					easyjsonB0091c22DecodeGithubComGoParkMailRu20232RabotyagiPkgModels1(in, &v7)
...
func easyjsonB0091c22EncodeGithubComGoParkMailRu20232RabotyagiPkgModels3(out *jwriter.Writer, in preProductJSON) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Images == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v8, v9 := range in.Images {
				...
				easyjsonB0091c22EncodeGithubComGoParkMailRu20232RabotyagiPkgModels1(out, v9)
			}
			out.RawByte(']')
		}
	}
...
// MarshalJSON supports json.Marshaler interface
func (v preProductJSON) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB0091c22EncodeGithubComGoParkMailRu20232RabotyagiPkgModels3(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}

// MarshalEasyJSON supports easyjson.Marshaler interface
func (v preProductJSON) MarshalEasyJSON(w *jwriter.Writer) {
	easyjsonB0091c22EncodeGithubComGoParkMailRu20232RabotyagiPkgModels3(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *preProductJSON) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonB0091c22DecodeGithubComGoParkMailRu20232RabotyagiPkgModels3(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *preProductJSON) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB0091c22DecodeGithubComGoParkMailRu20232RabotyagiPkgModels3(l, v)
}
