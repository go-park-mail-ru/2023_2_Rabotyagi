...
// Source: internal/product/delivery/basket_handler.go
//
// Generated by this command:
//
//	mockgen -source=internal/product/delivery/basket_handler.go -destination=internal/product/mocks/basket_handler.go -package=mocks
//
...
func (m *MockIBasketService) GetOrdersNotInBasketByUserID(ctx context.Context, userID uint64) ([]*models.OrderInBasket, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIBasketServiceMockRecorder) GetOrdersNotInBasketByUserID(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetOrdersNotInBasketByUserID", reflect.TypeOf((*MockIBasketService)(nil).GetOrdersNotInBasketByUserID), ctx, userID)
}

// GetOrdersSoldByUserID mocks base method.
func (m *MockIBasketService) GetOrdersSoldByUserID(ctx context.Context, userID uint64) ([]*models.OrderInBasket, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIBasketServiceMockRecorder) GetOrdersSoldByUserID(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetOrdersSoldByUserID", reflect.TypeOf((*MockIBasketService)(nil).GetOrdersSoldByUserID), ctx, userID)
}
