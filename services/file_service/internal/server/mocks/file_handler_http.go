...
// Source: /home/vilin/GolandProjects/2023_2_Rabotyagi/services/file_service/internal/server/delivery/file_handler_http.go
//
// Generated by this command:
//
//	mockgen -source=/home/vilin/GolandProjects/2023_2_Rabotyagi/services/file_service/internal/server/delivery/file_handler_http.go -destination=services/file_service/internal/server/mocks/file_handler_http.go --package=mocks
//
...
func (m *MockIFileServiceHTTP) SaveImage(r io.Reader) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SaveImage", r)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockIFileServiceHTTPMockRecorder) SaveImage(r any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SaveImage", reflect.TypeOf((*MockIFileServiceHTTP)(nil).SaveImage), r)
}
